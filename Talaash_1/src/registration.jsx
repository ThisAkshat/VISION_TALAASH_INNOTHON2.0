      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white shadow-md rounded-lg px-8 py-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="dateMissing" className="block text-sm font-medium text-gray-700">
                Date missing
              </label>
              <input
                type="date"
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Enter person's aadhaar_number"
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                required
              />
            </div>
            ...
            <div>
              <label htmlFor="personImage" className="block text-sm font-medium text-gray-700">
                Person image
              </label>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Enter person's identification mark"
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                required
              />
            </div>
